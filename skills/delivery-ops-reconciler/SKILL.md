...
context_files: [".context/org/ORG.md", ".context/org/divisions/delivery/CHARTER.md", ".context/org/divisions/platform-ops/CHARTER.md", ".context/SYSTEM.md", "scripts/healthcheck-all.sh"]
---
