...
- **Portfolio brief evaluator bug (known, 2026-07-09)**: portfolio packet lacks `indicators` key
  so the citation checker always fails. After 2 retries, file the blocker in the summary and move
  on — do not loop indefinitely.
